		...
		if(!isset($resultado) || get_num_rows($resultado) == 0){
			...
			$posts = array(
				array("deco", "Mid-Century", "El estilo Mid-Century se caracteriza por su elegancia atemporal, combinando líneas limpias, colores neutros y mobiliario funcional. Con sus formas geométricas y materiales naturales como la madera y el metal, este estilo es ideal para aquellos que buscan una decoración moderna y sofisticada en su hogar.
						...
						Además, la iluminación focal es una excelente manera de añadir profundidad y dimensión a una habitación. Juega con la intensidad de la luz y los ángulos para crear sombras y contrastes que añadan interés visual al espacio.", $fecha_actual, $fecha_actual, 1),
						...
						Para un toque final, añade accesorios como esculturas, relojes de pared o jarrones con diseños intrincados. El Art Déco es ideal para salones, dormitorios principales o incluso baños, donde se busca crear un ambiente lujoso y refinado.", $fecha_actual, $fecha_actual, 1),
						...
						Su diseño compacto los hace perfectos para dormitorios pequeños, donde cada pieza de mobiliario debe ser funcional y estética. Para integrarlos en tu decoración, elige un banco que combine con los colores y texturas de tu dormitorio.", $fecha_actual, $fecha_actual, 1),
						...
						Además, su brazo ajustable permite dirigir la luz exactamente donde la necesitas, lo que los hace perfectos para tareas que requieren precisión. Para completar el look, combínalos con muebles de madera recuperada o metal, y añade accesorios como estanterías abiertas o pósters vintage.", $fecha_actual, $fecha_actual, 1),
						...
						Para maximizar su funcionalidad, combínalas con cortinas traslúcidas que permitan el paso de la luz durante el día. De esta manera, puedes controlar la iluminación y la privacidad según tus necesidades. Además, las cortinas opacas son una excelente manera de reducir el ruido exterior, creando un ambiente más tranquilo y relajado.", $fecha_actual, $fecha_actual, 1),
						...
						Para un toque más dramático, elige tiras LED con cambio de color, que permiten ajustar la atmósfera según tu estado de ánimo o la ocasión. Desde tonos cálidos para relajarte hasta colores vibrantes para fiestas, las posibilidades son infinitas. Además, su instalación es sencilla y puede realizarse en casi cualquier superficie.", $fecha_actual, $fecha_actual, 1),
						...
						No olvides que los jarrones también pueden ser piezas de arte por sí mismos. Un jarrón único con un diseño escultórico puede convertirse en el punto focal de una habitación, atrayendo miradas y añadiendo personalidad a tu decoración.", $fecha_actual, $fecha_actual, 1),
						...
						Para maximizar su funcionalidad, elige un aparador con cajones y estantes que te permitan organizar tus pertenencias de manera eficiente. Combínalo con accesorios decorativos que reflejen tu personalidad y estilo, creando un espacio único y acogedor.", $fecha_actual, $fecha_actual, 1),
						...
						Para un toque final, añade elementos como colgantes de macramé, lámparas de fibras naturales y mantas tejidas. El Boho Chic no sigue reglas estrictas, así que siéntete libre de mezclar y combinar según tu gusto personal.", $fecha_actual, $fecha_actual, 2),
						...
						Para un impacto visual aún mayor, combina la lámpara de araña con otros elementos decorativos en tonos metálicos, como espejos dorados o mesas con patas de latón. Esto creará un ambiente sofisticado y cohesionado.", $fecha_actual, $fecha_actual, 2),
						...
						Para un toque personalizado, elige relojes con detalles únicos, como marcas romanas, esferas de madera o diseños abstractos. Un reloj de pared bien seleccionado no solo es funcional, sino que también puede convertirse en una obra de arte que refleje tu estilo personal.", $fecha_actual, $fecha_actual, 3),
					);
